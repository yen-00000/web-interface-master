...
class WebConfig:
    ...
    """
    # 测试系统名称
    system_name = read_config.get_web('system_name')
    ...
    # yaml脚本目录
    yaml_path = os.path.join(BASE_PATH, read_config.get_web('yaml_path'))

    # 通过率
    pass_rate = float(read_config.get_web('pass_rate'))
